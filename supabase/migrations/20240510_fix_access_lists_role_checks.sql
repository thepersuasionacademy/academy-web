-- Fix access lists role checks to use RPC functions instead of JWT token
-- Description: Updates the access lists functions to use is_admin and is_super_admin RPC functions

-- Create the functions directly in the public schema for easier access
...
GRANT EXECUTE ON FUNCTION public.get_access_lists_organized TO authenticated;
GRANT EXECUTE ON FUNCTION public.get_list_members TO authenticated; 